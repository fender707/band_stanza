...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { description: @info.description, image_url: @info.image_url, title: @info.title }
    end
  ...
  test "should update info" do
    put :update, id: @info, info: { description: @info.description, image_url: @info.image_url, title: @info.title }
    assert_redirected_to info_path(assigns(:info))
  end
